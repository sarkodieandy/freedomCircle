...
values
  ('premium_monthly_price', '{"amount": 29.99, "currency": "GHS"}', 'Monthly premium app plan price.'),
  ('premium_yearly_price', '{"amount": 299.99, "currency": "GHS"}', 'Yearly premium app plan price.'),
  ...
  ('free_recovery_goal_limit', '{"limit": 2}', 'Free user recovery goal limit.'),
  ('free_journal_entry_limit', '{"limit": 10}', 'Free user private journal entry limit.'),
...
values
  ('free', 'Free', 'Basic private accountability, prayer, community, and tracking.', 'user', 'free', 0, 'GHS', 0, true, 10),
  ('premium_monthly', 'Premium Monthly', 'Unlimited personal growth features, premium groups, guided plans, and helper matching.', 'user', 'monthly', 25, 'GHS', 7, true, 20),
  ('premium_yearly', 'Premium Yearly', 'Premium access with discounted yearly pricing and yearly badge.', 'user', 'yearly', 250, 'GHS', 7, true, 30),
  ('church_starter', 'Church Starter', 'Private church groups, announcements, prayer requests, and basic reports.', 'church', 'monthly', 150, 'GHS', 0, true, 40),
  ('church_growth', 'Church Growth', 'Expanded member capacity, helper assignment, reports, events, and admin roles.', 'church', 'monthly', 400, 'GHS', 0, true, 50),
  ('church_pro', 'Church Pro', 'Advanced reports, multiple admins, branded organization page, exports, and priority support.', 'church', 'monthly', 800, 'GHS', 0, true, 60)
...
join (
  values
    ...
    ('premium_monthly', 'advanced_insights', 'Advanced insights', 'Unlock charts, trigger insights, and weekly reports.', null),
    ...
    ('premium_yearly', 'advanced_insights', 'Advanced insights', 'Unlock charts, trigger insights, and weekly reports.', null),
